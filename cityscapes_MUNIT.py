...
class cityscapes(data.Dataset):
	def __init__(self, dataroot, new_size, height, width, train_split=False, crop=False, flip=False, set='train'):
		self.root = dataroot
		...
		if train_split:
			self.dir_images = os.path.join(dataroot, 'cityscapes', 'leftImg8bit_trainvaltest', 'leftImg8bit', set)
			self.dir_labels = []
		else:
			self.dir_images = os.path.join(dataroot, 'cityscapes', 'leftImg8bit_trainvaltest', 'leftImg8bit', 'val')
			self.dir_labels = os.path.join(dataroot, 'cityscapes', 'gtFine_trainvaltest', 'gtFine', 'val')
		...
		if self.dir_labels:
			self.path_labels = make_cs_labels(self.dir_labels)
