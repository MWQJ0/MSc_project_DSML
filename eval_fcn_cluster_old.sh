...
#$ -j y
#$ -N eval_fcn8s_iter90000.pth_eval_fcn8s_prob0.8_std10
...
python /cluster/project9/MUNIT/segmentation_kyveli/segmentation/eval_fcn.py \
    --path '/cluster/project9/MUNIT/segmentation_kyveli/segmentation/results/train_fcn8s_0.8_workers2_coeff10/cityscapes_fcn8s-iter90000.pth' \
    --dataset cityscapes \
