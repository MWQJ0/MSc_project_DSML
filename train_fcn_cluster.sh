...
#$ -j y
#$ -N train_fcn8s_0.8_19aug_coeff10
...
python /cluster/project9/MUNIT/segmentation_kyveli/segmentation/train_fcn.py \
    --outdir /cluster/project9/MUNIT/segmentation_kyveli/segmentation/results/train_fcn8s_0.8_19aug_coeff10/cityscapes_fcn8s \
    --logdir /cluster/project9/MUNIT/segmentation_kyveli/segmentation/runs/train_fcn8s_0.8_19aug_coeff10\
    --model fcn8s \
    --num_cls 19 \
    --lr 1e-3 \
    --batch_size 1 \
    ...
    --dataset cityscapes \
--config_path /cluster/project9/MUNIT/segmentation_kyveli/segmentation/gta2cityscapes_folder_MUNIT.yaml \
